...
--
-- Host: localhost    Database: chamilo_db
-- ------------------------------------------------------
...
INSERT INTO `access_url` VALUES
(1,'http://localhost/',' ',1,1,'2026-08-18 13:15:02',NULL);
...
INSERT INTO `access_url_rel_course_category` VALUES
(1,1,1),
(2,1,2),
(3,1,3);
...
INSERT INTO `branch_sync` VALUES
(1,NULL,1,'6637e340536efbdce7c019c1cd2bf9b62b5b8caa','localhost',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'85085b4328e8e3c8a4e004284f05cbab5e76593a',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `c_forum_thread` (
  ...
  `thread_poster_name` varchar(100) DEFAULT NULL,
...
CREATE TABLE `c_item_property` (
  ...
  `lastedit_date` datetime NOT NULL,
  `ref` int(11) NOT NULL,
  `lastedit_type` varchar(100) NOT NULL,
  `lastedit_user_id` int(11) NOT NULL,
...
CREATE TABLE `c_link` (
  ...
  `display_order` int(11) NOT NULL,
  `on_homepage` varchar(10) NOT NULL,
...
CREATE TABLE `c_role` (
  ...
  `role_comment` longtext DEFAULT NULL,
...
CREATE TABLE `c_student_publication` (
  ...
  `url_correction` varchar(255) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `title_correction` varchar(255) DEFAULT NULL,
  `description` longtext DEFAULT NULL,
...
INSERT INTO `extra_field` VALUES
(1,1,1,'legal_accept','Legal',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(2,1,1,'already_logged_in','Already logged in',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(3,1,1,'update_type','Update script type',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(4,1,10,'tags','tags',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(5,1,1,'rssfeeds','RSS',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(6,1,1,'dashboard','Dashboard',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(7,1,11,'timezone','Timezone',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(8,1,4,'mail_notify_invitation','MailNotifyInvitation','1',NULL,0,NULL,1,NULL,'2026-08-18 13:15:02'),
(9,1,4,'mail_notify_message','MailNotifyMessage','1',NULL,0,NULL,1,NULL,'2026-08-18 13:15:02'),
(10,1,4,'mail_notify_group_message','MailNotifyGroupMessage','1',NULL,0,NULL,1,NULL,'2026-08-18 13:15:02'),
(11,1,1,'user_chat_status','User chat status',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(12,1,1,'google_calendar_url','Google Calendar URL',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(13,2,13,'special_course','Special course','',NULL,1,NULL,1,NULL,'2026-08-18 13:15:02'),
(14,2,10,'tags','Tags',NULL,NULL,1,NULL,1,NULL,'2026-08-18 13:15:02'),
(15,2,19,'video_url','VideoUrl',NULL,NULL,1,NULL,1,NULL,'2026-08-18 13:15:02'),
(16,3,16,'image','Image',NULL,NULL,1,NULL,1,NULL,'2026-08-18 13:15:02'),
(17,1,1,'captcha_blocked_until_date','Account locked until',NULL,NULL,0,NULL,0,NULL,'2026-08-18 13:15:02'),
(18,1,1,'skype','Skype',NULL,NULL,1,NULL,1,NULL,'2026-08-18 13:15:02'),
(19,1,1,'linkedin_url','LinkedInUrl',NULL,NULL,1,NULL,1,NULL,'2026-08-18 13:15:02'),
(20,8,10,'tags','Tags',NULL,NULL,1,NULL,1,NULL,'2026-08-18 13:15:02');
...
INSERT INTO `extra_field_options` VALUES
...
INSERT INTO `extra_field_values` VALUES
(1,2,'true',1,'2026-08-18 13:15:02','2026-08-18 13:18:51',NULL),
(2,2,'false',2,'2026-08-18 13:15:02','2026-08-18 13:15:02',NULL);
...
(16,NULL,'F├©royskt','faroese','fo','faroese',0),
...
CREATE TABLE `openid_association` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idp_endpoint_uri` longtext NOT NULL,
  `session_type` varchar(30) NOT NULL,
  `assoc_handle` longtext NOT NULL,
  `assoc_type` longtext NOT NULL,
  `expires_in` bigint(20) NOT NULL,
  `mac_key` longtext NOT NULL,
...
INSERT INTO `sequence_condition` VALUES
(1,'<= 100%','<=',100,2,'0'),
(2,'>= 70%','>=',70,0,'');
...
INSERT INTO `sequence_method` VALUES
...
INSERT INTO `sequence_rule` VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=376 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'Institution',NULL,'textfield','Platform','Cloud Lab','InstitutionTitle','InstitutionComment','platform',NULL,1,1,0),
(2,'InstitutionUrl',NULL,'textfield','Platform','https://chamilo.org','InstitutionUrlTitle','InstitutionUrlComment',NULL,NULL,1,1,0),
(3,'siteName',NULL,'textfield','Platform','Chamilo Cloud Lab','SiteNameTitle','SiteNameComment',NULL,NULL,1,1,0),
(4,'emailAdministrator',NULL,'textfield','Platform','webmaster@localhost.localdomain','emailAdministratorTitle','emailAdministratorComment',NULL,NULL,1,1,0),
(5,'administratorSurname',NULL,'textfield','Platform','Rossi','administratorSurnameTitle','administratorSurnameComment',NULL,NULL,1,1,0),
(6,'administratorName',NULL,'textfield','Platform','Mario','administratorNameTitle','administratorNameComment',NULL,NULL,1,1,0),
...
(14,'platformLanguage',NULL,'link','Languages','italian','PlatformLanguageTitle','PlatformLanguageComment',NULL,NULL,1,0,0),
...
(94,'permissions_for_new_files',NULL,'textfield','Security','0600','PermissionsForNewFiles','PermissionsForNewFilesComment',NULL,NULL,1,0,1),
...
(1,NULL,'Root','root','',1,'',NULL,1,'2026-08-18 13:15:02');
...
INSERT INTO `skill_rel_skill` VALUES
(1,1,0,0,0);
...
(1,1,'Iscrizione','Ticket sull\'iscrizione',0,0,1,'2026-08-18 13:15:02',NULL,NULL),
(2,1,'Informazioni generali','Ticket sulle informazioni generali',0,0,1,'2026-08-18 13:15:02',NULL,NULL),
(3,1,'Richieste e pratiche','Ticket si richieste e pratiche',0,0,1,'2026-08-18 13:15:02',NULL,NULL),
(4,1,'Condotte accademiche improprie','Ticket su comportamenti inappropriati, su esami, compiti, atteggiamenti ecc.',0,0,1,'2026-08-18 13:15:02',NULL,NULL),
(5,1,'Campus virtuale','Ticket sul Campus virtuale',0,0,1,'2026-08-18 13:15:02',NULL,NULL),
(6,1,'Valutazione online','Ticket sulla valutazione online',0,1,1,'2026-08-18 13:15:02',NULL,NULL);
...
(1,'Normale','NRM',NULL,'','',1,'2026-08-18 13:15:02',NULL,NULL),
(2,'Alta','HGH',NULL,'','',1,'2026-08-18 13:15:02',NULL,NULL),
(3,'Bassa','LOW',NULL,'','',1,'2026-08-18 13:15:02',NULL,NULL);
...
INSERT INTO `ticket_project` VALUES
(1,'Ticket System',NULL,NULL,NULL,1,'2026-08-18 13:15:02',NULL,NULL);
...
(1,'NAT','Nuovo',NULL),
(2,'PND','Pendente',NULL),
(3,'XCF','Non confermato',NULL),
(4,'CLS','Chiuso',NULL),
(5,'REE','Inoltrato',NULL);
...
INSERT INTO `track_e_default` VALUES
(1,0,0,'2026-08-18 13:15:02','user_created','user_id','1',0),
(2,0,0,'2026-08-18 13:15:02','user_created','user_id','2',0);
...
CREATE TABLE `track_e_downloads` (
  ...
  `c_id` int(11) NOT NULL,
  `down_doc_path` varchar(255) NOT NULL,
...
INSERT INTO `track_e_login` VALUES
(1,1,'2026-08-18 13:18:51','172.19.0.1','2026-08-18 13:18:54');
...
INSERT INTO `track_e_online` VALUES
(1,1,'2026-08-18 13:18:54','172.19.0.1',0,0,1);
...
CREATE TABLE `track_e_open` (
  ...
  `open_remote_host` longtext NOT NULL,
  `open_agent` longtext NOT NULL,
  `open_referer` longtext NOT NULL,
...
CREATE TABLE `track_e_uploads` (
  ...
  `upload_date` datetime NOT NULL,
  `upload_cours_id` varchar(40) NOT NULL,
  `c_id` int(11) DEFAULT NULL,
...
CREATE TABLE `track_stored_values` (
  ...
  `sv_key` varchar(64) NOT NULL,
  `sv_value` longtext NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  ...
  `auth_source` varchar(50) DEFAULT NULL,
  `status` int(11) NOT NULL,
...
(1,1,'admin','admin','webmaster@localhost.localdomain','webmaster@localhost.localdomain',0,1,0,0,NULL,NULL,'Rossi','Mario','$2y$04$2/IeomoSHbGki/3ZMrH8zORtJlnIBCfoVVzww7jGXjKkXSuqIKH2i','(000) 001 02 03','','9vGc/UsRkRefssl1gWpOpbdrbFTneLqgJlFuzooTrnk','2026-08-18 13:18:54',NULL,NULL,NULL,NULL,'a:1:{i:0;s:16:\"ROLE_SUPER_ADMIN\";}',NULL,'platform',1,'ADMIN','',0,NULL,NULL,NULL,NULL,NULL,'italian','2026-08-18 13:15:02',NULL,1,NULL,NULL,0),
(2,2,'anon','anon','anonymous@example.com','anonymous@example.com',0,1,0,0,NULL,NULL,'Anonymous','Joe','$2y$04$pygYCr.a/6Pdt2FCfC6DYe49klRhwkFZP2am3DVfCR/Mv1yeipkQy','','','WJCN.RD5T0aBior0ngXLp1QB/9ibwdqbbeKH/08joiI',NULL,NULL,NULL,NULL,NULL,'a:0:{}',NULL,'platform',5,'anonymous','',0,NULL,NULL,NULL,NULL,NULL,'italian','2026-08-18 13:15:02',NULL,1,NULL,NULL,0);
...
-- Dump completed on 2026-08-18 13:43:11
